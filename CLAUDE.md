...
Latest migration: **129** (`km_migration_129_jupiter_almanac.sql` — Jupiter Retrograde + Sign Transit rules, unified `Jupiter` tag for the almanac view)
