...
Latest migration: **132** (`km_migration_132_rule_patterns.sql` — `km_rule_patterns` table, Astro Pattern Engine Phase 1; POA: `docs/POA/POA-astro-pattern-engine.md`)
