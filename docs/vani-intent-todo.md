...
The original menu reduction required no migration. The index-detail narrative update now requires deploying the backend too: sector intent version 6 invalidates old cached explanations.
