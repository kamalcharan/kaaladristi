    ...
    try {
      ...
      try {
        ...
        if(calculation.leadership_refresh_error) {
          createdIndexId=null;
          navigate(`/custom-index/${newIndex.id}/manage`, {state:{computeError:'Index calculated; longer-term snapshot refresh is pending. Retry Calculate after other baskets finish rebuilding.'}});
          return;
        }
      } catch {
        createdIndexId=null;
          ...
          <div style={{ marginTop: 'auto', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <button
              ...
              style={{
                ...
                borderRadius: '8px',
                border: 'none',
                background: canSave && !saving ? 'var(--accent-indigo)' : 'color-mix(in srgb, var(--text-primary) 6%, transparent)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span
              style={{
                ...
                padding: '1px 7px',
                borderRadius: '100px',
                background: basket.length > 0 ? 'var(--accent-indigo)' : 'color-mix(in srgb, var(--text-primary) 8%, transparent)',
