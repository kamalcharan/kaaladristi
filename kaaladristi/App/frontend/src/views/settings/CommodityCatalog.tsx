  ...
  return (
    <div>
      ...
      <header className="mb-6">
        <h2 className="text-2xl font-bold tracking-tight text-white mb-1">Commodity Data</h2>
        ...
        <>
          <div className="grid gap-1.5">
            {paged.map((item: CommodityCatalogItem) => (
              <div
                key={item.id}
                className="flex items-center gap-3 bg-[#0f172a] border border-kd-border rounded-xl px-4 py-2.5"
              >
                {/* Symbol */}
                ...
                {/* Name */}
                <span className="text-[12px] text-slate-400 truncate flex-1 hidden sm:inline">
                  {item.name ?? '—'}
                </span>
