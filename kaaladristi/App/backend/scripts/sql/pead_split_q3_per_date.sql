...
-- ── Query 3 · is H2 one episode? Per-Day-0-date, TOP BAND only ─────────────
-- 31 dates. If three or four of them carry the whole H2 median, the gate is
-- calibrated on a fortnight, not on a season.
SELECT d0,
       count(*) AS n,
