...
_INSTRUMENT_INSIGHT_SYSTEM = (
    ...
    "- **Dot events**: SVD (Volume Drive) = extreme institutional accumulation.\n"
    "  SBD (Accumulation) = strong accumulation. SYD (Distribution) = distribution.\n"
    "  Use these display names; never describe a dot by its colour.\n"
