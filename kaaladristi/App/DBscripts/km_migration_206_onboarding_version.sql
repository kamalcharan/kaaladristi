...
-- persona_set_at has, by definition, completed the v1 flow — stamp them 1 and
-- leave them alone. Everyone else lands on 0 by DEFAULT and is sent back.
...
-- ── 3. Targeted stamp ───────────────────────────────────────────────────────
-- Anyone who already answered the persona questions has completed v1. On
-- 2026-09-12 that was 2 of 17 profiles; the other 15 carry no ICP at all and
-- are the reason for this migration.
UPDATE km_profiles
