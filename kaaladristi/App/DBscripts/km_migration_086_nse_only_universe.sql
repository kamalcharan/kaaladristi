-- ============================================================
-- Migration 086 · Simplify aggregate universe to NSE-only
--
-- Replace the ISIN-dedup CTE with a direct NSE filter.
-- Universe = all active NSE stocks (~1,380 rows).
-- TRUNCATE both tables for clean backfill.
-- ============================================================
